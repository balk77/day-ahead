...
class DaPrices:
    ...
    def get_prices(self, source):
        ...
        try:
            ...
            logging.info(f"Fout bij ophalen prijzen voor {vandaag}. Dit kan betekenen dat {source.lower()} niet beschikbaar is of dat de data voor deze dag nog niet beschikbaar is. Probeer het na 13:00 nogmaals.")
